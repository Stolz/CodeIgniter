...
<div class="example">
	...
	<p class="text-center">All columns must be wrapped by a <code>.row</code> container</p>
	...
	<a name="grid_don_float_last"></a><br/><p class="text-center">Last column always floats to the right. To avoid this behavior add the class <code>.end</code></p>
	...
	<a name="grid_mobile"></a><br/><p class="text-center">On Mobile, columns become stacked. They all will be the full width no matter what kind they were before. To keep an up to 4 columns layout in mobile add the class <code>.mobile-N</code></p>
	...
	<div class="row">
		<div class="twelve columns">
			<a name="blockgrid"></a>
			<h3>Block grids</h3>
			<p>Block grids are ideal for blocked-in content generated by an application, as they <b>do not require rows</b> or even numbers of elements to display correctly. They are made from a <code>ul.block-grid</code> with <code>#-up</code></p>
