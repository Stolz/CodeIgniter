...
$config['tidy_open_tag'] = '<div id="tidy_errors" style="position: absolute;right: 0;top: 0;z-index: 10;padding:1em;margin:1em;border:1px solid #DC0024;background-color:#FFE5E5;color:#DC0024"><div style="float:right;cursor:pointer"><a onclick="document.getElementById(\'tidy_errors\').style.visibility = \'hidden\'">[close]</a></div>';
