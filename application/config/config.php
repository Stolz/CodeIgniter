...
|
*/
$config['base_url']	= (ENVIRONMENT == 'production') ? 'http://'.PROJECT_DOMAIN.'/' : 'http'.((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on') ? 's' : '').'://'.$_SERVER['HTTP_HOST'].str_replace('//','/',dirname($_SERVER['SCRIPT_NAME']).'/');
...
|
*/
$config['allow_get_array']		= TRUE; //OAuth 2 library uses $_GET
...
$config['sess_use_database']	= FALSE; //to-do fore security and storage reasons it's recommended to set this to TRUE
...
|
*/
$config['time_reference'] = 'local';  //to-do if your server is set to UTC change to gmt
