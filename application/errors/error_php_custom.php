...
<div id="exception_error">
	...
	<div id="<?php echo $error_id ?>" class="content">
		<h2> OPEN <a class="file" href="subl://open?url=file://<?= urlencode(MY_Exceptions::debug_path($file)) ?>&line=<?= $line ?>"><?php echo MY_Exceptions::debug_path($file) ?> [ <?php echo $line ?> ]</a></h2>
